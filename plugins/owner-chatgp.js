...
let fakegif = { key: {participant: `0@s.whatsapp.net`, ...("5212411719888@g.us" ? { remoteJid: "5212411719888@g.us" } : {})},message: {"videoMessage": { "title": '⫷᭄ʜᴀᴅᴇs-ʙᴏᴛ-ᴍᴅ﹏✍', "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': '⫷᭄ʜᴀᴅᴇs-ʙᴏᴛ-ᴍᴅ﹏✍', 'jpegThumbnail': false }}}
let teks = `*☘️ • 𝙶𝚛𝚞𝚙𝚘:* ${groupMetadata.subject}\n*📌 • 𝙳𝚎:* ${name}\n*🍁 • 𝙽𝚞́𝚖𝚎𝚛𝚘:* wa.me/${who.split`@`[0]}\n*📧 • 𝙼𝚎𝚗𝚜𝚊𝚓𝚎:* ${text}`
